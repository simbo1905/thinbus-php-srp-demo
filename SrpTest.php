...
class NotRandomSrp extends Srp {
    ...
    function setK($nr) {
        $this->k = new BigInteger($nr, 16);
    }
    
    function computeK() {
        // do nothing use the value we were given
    }
}
...
class SrpTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Tests the step2 using values taken from thinbus js+java tests. Note we overload the 'k' and 'b' values to values the java library gives when debugging.
	 */
	public function testStep2() {
	    ...
	    $this->Srp->setK("1a3d1769e1d6337af78796f1802f9b14fbc20278fb6e15e4361beb38a8e7cd3a");
